...
# --- settings ---
export GI_LLAMA_EXE="$( cd "${BASH_SOURCE[0]%/*}/../../llama.cpp/build/bin" && pwd )"/llama-server
export GI_MODELS_DIR="${GI_MODELS_DIR:-$(p=;find "$HOME" /mnt -type f -name '*.gguf' -printf '%h\0'|
