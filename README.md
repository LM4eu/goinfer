...
⚠️ **Not yet implemented. Please contribute. Contact us <team@LynxAI.eu>** ⚠️
...
```sh
git clone https://github.com/LynxAIeu/goinfer
cd goinfer
...
In March 2023, [Goinfer](https://github.com/LynxAIeu/goinfer)
...
- **Dependencies:**
  ...
  - [llama-swap](https://github.com/LynxAIeu/llama-swap) – MIT
