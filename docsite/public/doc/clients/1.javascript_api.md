...
Install the [@goinfer/api](https://github.com/lynxai-team/goinfer-js/packages/api) library:

```bash
npm install --prefer-offline --no-audit --no-fund @goinfer/api
```
...
[Typescript example usage](https://github.com/lynxai-team/goinfer/blob/main/examples/js/template/goinfer_lib.ts)
