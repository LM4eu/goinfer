...
Install the [@goinfer/api](https://github.com/LynxAIeu/goinfer-js/packages/api) library:
...
[Typescript example usage](https://github.com/LynxAIeu/goinfer/blob/main/examples/js/template/goinfer_lib.ts)
